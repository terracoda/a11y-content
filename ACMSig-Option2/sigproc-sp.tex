...
\title{Ramp it up! Action based guide for creating accessible websites}
...
% 1st. author
\alignauthor
Taliesin L. Smith\titlenote{MDes. (Candidate) Inclusive Design, OCAD University}\\
       \affaddr{OCAD University}\\
       \affaddr{Toronto, Ontario, Canada}\\
       \email{ts14hh@student.ocadu.ca}
% 2nd. author
%\alignauthor
...
As designers, developers, content authors we continue to struggling 
with working web accessibility into our workflows. This action based 
guide summarizes and simplifies key aspects of the WCAG 2.0 and
is intended to help people make design and development decisions 
to remove barriers in websites and web applications.
...
\begin{figure}
\centering
\epsfig{file=rosette.eps, height=1in, width=1in,}
